...
exports.run = (client, message) => {
    ...
    var kyzerdensaabler = kyzerdensaabler[Math.floor(Math.random(1) * kyzerdensaabler.length)]
    const kyzerdenasabler  = new Discord.MessageEmbed()
    .setImage("https://cdn.wallpapersafari.com/40/16/8rTMh6.jpg")
    .setAuthor('Bot', csgopng)
    .setDescription(`${kyzerdenasabler}`)
    ...
    .setColor("RANDOM")
    return message.channel.send(kyzerdenasabler);
};
